...
<body>
    <header class="topo">
        ...
        <section class="block">
            ...
            <section class="carrinho">
                ...
                <a href="carrinho.html"><img src="img/carrinho.png" alt="carrinho de compras" id="carrinho" onclick="carrinho()"></a>
            </section>
        </section>
    </header>
    <main>
        <!-- ? Section onde ficará armazenada todos os livros dos quais os usuarios pesquisarem ou os produtos que estaram em descontos. -->
        <section class="Fileira" id="id">
            <!-- ? Section onde fica os livros e suas devidas informações. -->
    ...
    <!-- ? Footer feito para dar os devidos creditos para todos os colaboradores do site. -->
    <footer>
